        ...
        <div class="main-content">
          <div class="hero__content">
            ...
            <a
              target="_blank"
              rel="noopenner"
              href="https://cie.ptit.edu.vn/vi/prog/chuong-trinh-ky-su-cong-nghe-thong-tin-viet-nhat-cua-hoc-vien-cong-nghe-buu-chinh-vien-thong-nam-2024/"
            >
      ...
      <section class="activity">
        <div class="main-content">
          ...
          <div class="activity__content">
            <p>
              Tham gia chương trình Kỹ sư Công nghệ thông tin, sinh viên sẽ có
              cơ hội:
            </p>
            <ul class="activity__list" style="list-style-type: disc">
              <li>
                <p>
                  Được đào tạo thực tế với học kỳ doanh nghiệp Nhật tại Việt Nam
                  và Nhật Bản. Các doanh nghiệp sẽ đồng hành cùng sinh viên để
                  làm các project, sản phẩm thực tế.
                </p>
              </li>
              <li>
                <p>
                  Định hướng nghề nghiệp rõ ràng, trang bị các kỹ năng mềm, kỹ
                  năng làm việc phù hợp với văn hóa doanh nghiệp Nhật Bản.
                </p>
              </li>
              <li>
                <p>
                  Tham gia chuỗi Workshop cùng các chuyên gia công nghệ hàng đầu
                  tại các doanh nghiệp Nhật Bản.
                </p>
              </li>
              <li>
                <p>
                  Tham gia các hoạt động ngoại khoá hàng năm, đặc biệt các hoạt
                  động trao đổi văn hoá tại Nhật Bản.
                </p>
              </li>
            </ul>
          </div>
